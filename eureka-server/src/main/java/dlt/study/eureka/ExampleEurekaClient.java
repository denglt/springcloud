...
public class ExampleEurekaClient {
    ...
    private String vipAddress = "eureka.mydomain.net";// "sampleservice.mydomain.net";
    ...
    public void getInstances(EurekaClient eurekaClient) {
        eurekaClient.getInstancesByVipAddress(vipAddress, false).forEach((i) -> {
    ...
    public static void main(String[] args) {
        ...
        sampleClient.getInstances(client);
    ...
    public static void main2(String[] args) {
        ...
        System.out.println(eurekaClientConfig);
        String registryRefreshSingleVipAddress = eurekaClientConfig.getRegistryRefreshSingleVipAddress();
        System.out.println("vip -> " + registryRefreshSingleVipAddress);
        // use the client
